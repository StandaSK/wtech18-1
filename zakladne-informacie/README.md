...
* **Odovzdanie 2. fázy projektu: 5. týždeň - 20.10. do 23:59 v AIS, 10 bodov (8 + 2 body),** vytvorenie responzívnych šablón (8 bodov); návrh dátového modelu a implementovaný relačný model (2 body) 
